				...
				<div class="span12">
					<div class="slider-wrapper theme-bar">
						...
						<div id="slider1" class="nivoslider">
							<a href="#"><img src="<?php echo Yii::app()->request->baseUrl.'/themes/frontEnd'; ?>/img/header_01.jpg"></a>
							<a href="#"><img src="<?php echo Yii::app()->request->baseUrl.'/themes/frontEnd'; ?>/img/header_02.jpg" ></a>
							<img src="<?php echo Yii::app()->request->baseUrl.'/themes/frontEnd'; ?>/img/header_03.jpg" alt="">
						</div>
					</div>
				</div>
			</div>
