    ...
    'items'=>array(
        array(
            ...
            'items'=>array(
                ...
                array('label'=>'Contact', 'url'=>Yii::app()->getModule('user')->contactoEmpresaUrl,'visible'=>!Yii::app()->user->isGuest,'icon'=>'envelope', 'active'=>Yii::app()->controller->action->id=='contact'),
