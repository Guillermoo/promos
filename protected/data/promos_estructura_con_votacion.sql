...
--
-- Servidor: localhost
-- Tiempo de generación: 16-01-2014 a las 14:08:47
...
CREATE TABLE IF NOT EXISTS `tbl_compras` (
  ...
  `estado` tinyint(1) NOT NULL COMMENT 'Indica el estado de la venta. Si ha sido correcta valdrá 1. Si ha sido cancelada valdrá 0',
  `referencia` varchar(256) COLLATE utf8_spanish_ci NOT NULL COMMENT 'Guardar la referencia que asigna Paypal a cada compra',
  `precio` int(11) NOT NULL,
  `votado` tinyint(2) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
...
--
-- Estructura de tabla para la tabla `tbl_emp_cat`
--
...
--
-- Estructura de tabla para la tabla `tbl_poblaciones`
--
...
CREATE TABLE IF NOT EXISTS `tbl_promociones` (
  ...
  `descripcion_html` varchar(1000) DEFAULT NULL,
  ...
  `votos_cantidad` int(11) DEFAULT NULL,
  `votos_media` int(11) DEFAULT NULL,
  `votos_suma` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `empresa_id` (`user_id`),
  KEY `categoria_id` (`categorias_id`),
  KEY `voto_id` (`votos_id`)
...
CREATE TABLE IF NOT EXISTS `tbl_votos` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `votos_cantidad` int(11) NOT NULL DEFAULT '0',
  `votos_media` varchar(50) CHARACTER SET armscii8 COLLATE armscii8_bin NOT NULL DEFAULT '2.5',
  `votos_suma` int(11) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
