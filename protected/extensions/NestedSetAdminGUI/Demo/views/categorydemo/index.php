...
<div id="<?php echo Categorydemo::ADMIN_TREE_CONTAINER_ID;?>" >

</div>

<script  type="text/javascript">
$(function () {
$("#<?php echo Categorydemo::ADMIN_TREE_CONTAINER_ID;?>")
		.jstree({
                           "html_data" : {
	            "ajax" : {
                                 "type":"POST",
 	                          "url" : "<?php echo $baseUrl;?>/categorydemo/fetchTree",
	                         "data" : function (n) {
	                          return {
...
"update" : {
	              ...
	              "action"	: function (obj) {
                     ...
                     $.ajax({
                                 type: "POST",
                                 url: "<?php echo $baseUrl;?>/categorydemo/returnForm",
                                data:{
                                          'update_id':  id,
                                           "YII_CSRF_TOKEN":"<?php echo Yii::app()->request->csrfToken;?>"
                                              },
	...
	"action" : function (obj) {
                             ...
                             $.ajax({
                                   type:"POST",
			           url:"<?php echo $baseUrl;?>/categorydemo/returnView",
		                   data:   {
                                             "id" :id,
                                            "YII_CSRF_TOKEN":"<?php echo Yii::app()->request->csrfToken;?>"
                                              },
...
"remove" : {
			...
			buttons: {
				       "Delete": function() {
                                        jQuery("#<?php echo Categorydemo::ADMIN_TREE_CONTAINER_ID;?>").jstree("remove",obj);
					$( this ).dialog( "close" );
				},
				Cancel: function() {
					$( this ).dialog( "close" );
	...
	"action" : function (obj) {
			           ...
			           data:  {
				         "id" :id,
                                       ...
                                       beforeSend : function(){
                                           $("#<?php Categorydemo::ADMIN_TREE_CONTAINER_ID ?>").addClass("ajax-sending");
                                                               },
                                        complete : function(){
                                              $("#<?php Categorydemo::ADMIN_TREE_CONTAINER_ID ?>").removeClass("ajax-sending");
                                                             },
...
//	}//list products
		...
		$.ajax({
                           type:"POST",
			   url:"<?php echo $baseUrl;?>/categorydemo/rename",
			   data:  {
		...
		$.ajax({
                           type:"POST",
			    url:"<?php echo $baseUrl;?>/categorydemo/remove",
			    data:{
				        "id" : data.rslt.obj.attr("id").replace("node_",""),
			                "YII_CSRF_TOKEN":"<?php echo Yii::app()->request->csrfToken;?>"
                                        },
...
.bind("move_node.jstree", function (e, data) {
		data.rslt.o.each(function (i) {
                ...
                //Commented out logs  are for debugging and exploration of jstree.
                 ...
                 next= jQuery.jstree._reference('#<?php echo Categorydemo::ADMIN_TREE_CONTAINER_ID;?>')._get_next (this, true);
                 previous= jQuery.jstree._reference('#<?php echo Categorydemo::ADMIN_TREE_CONTAINER_ID;?>')._get_prev(this,true);
...
//                      console.log(replaced_node,'REPLACED NODE');
			...
			$.ajax({
				async : false,
				type: 'POST',
				url: "<?php echo $baseUrl;?>/categorydemo/moveCopy",
...
//BINDING EVENTS FOR THE ADD ROOT AND REFRESH BUTTONS.
   $("#add_root").click(function () {
	$.ajax({
		...
		jQuery("#<?php echo Categorydemo::ADMIN_TREE_CONTAINER_ID;?>").jstree("refresh");
	});
});
