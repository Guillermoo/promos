...
<?php $form=$this->beginWidget('UActiveForm', array(
    ...
    <div class="modal-body">
		...
		<p>Las presentes Condiciones Generales de Uso, Política de Privacidad y Venta (en adelante, las "Condiciones Generales") regulan el uso del sitio web www.proemocion.com (en adelante, el Sitio Web) que Proemoción, pone a disposición de las personas que accedan a su Sitio Web con el fin de proporcionales información sobre productos y servicios, propios y/o de terceros colaboradores, y facilitarles el acceso a los mismos, así como la contratación de servicios y bienes por medio de la misma (todo ello denominado conjuntamente los "Servicios").</p>

		<p>Para contactar con Proemoción, puede utilizar la dirección de correo electrónica proemocion@proemocion.com.
