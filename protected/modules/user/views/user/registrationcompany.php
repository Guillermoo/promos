...
<?php $form=$this->beginWidget('UActiveForm', array(
    ...
    <div class="modal-body">
		...
		<p>Las presentes Condiciones Generales de Uso, Política de Privacidad y Venta (en adelante, las "Condiciones Generales") regulan el uso del sitio web www.proemocion.com (en adelante, el Sitio Web) que Proemoción, S.L. (en adelante "Proemoción"), pone a disposición de las personas que accedan a su Sitio Web con el fin de proporcionales información sobre productos y servicios, propios y/o de terceros colaboradores, y facilitarles el acceso a los mismos, así como la contratación de servicios y bienes por medio de la misma (todo ello denominado conjuntamente los "Servicios").</p>

		<p>Proemoción, con domicilio social en Calle Pintores, 2 D.102.3 28923 Alcorcón (Madrid) , es una sociedad de responsabilidad limitada española titular del presente Sitio Web cuya utilización se regula mediante este documento, con CIF número XXXXXXXXX e inscrita en el Registro Mercantil de Madrid al Tomo 27.335, Hoja M-492.541, Folio 89, Sección 8, inscripción primera. Para contactar con Proemoción, puede utilizar la dirección de correo postal arriba indicada, así como la dirección de correo electrónica proemocion@proemocion.com.
		Por la propia naturaleza del Sitio Web, así como de su contenido y finalidad, la práctica totalidad de la navegación que se puede llevar a cabo por el mismo ha de hacerse gozando de la condición de Cliente, la cual se adquiere según los procedimientos recogidos en la misma. Por lo tanto, la citada condición de Cliente supone la adhesión a las Condiciones Generales en la versión publicada en el momento en que se acceda al Sitio Web. Proemoción se reserva el derecho de modificar, en cualquier momento, la presentación y configuración del Sitio Web, así como las presentes Condiciones Generales. Por ello, Proemoción recomienda al Cliente leer el mismo atentamente cada vez que acceda al Sitio Web.</p>

		<p>En cualquier caso, existen páginas del Sitio Web accesibles al público en general, respecto a las cuales Proemoción también desea cumplir con sus obligaciones legales, así como regular el uso de las mismas. En este sentido, los usuarios que accedan a estas partes del Sitio Web aceptan quedar sometidos, por el hecho de acceder a las citadas páginas, por los términos y condiciones recogidos en estas Condiciones Generales, en la medida que ello les pueda ser de aplicación.</p>
		...
		realizar cualquier acto que pueda ser considerado una vulneración de cualesquiera derechos de propiedad intelectual o industrial pertenecientes a Proemoción o a terceros;
		...
		El Cliente responderá de los daños y perjuicios de toda naturaleza que Proemoción pueda sufrir, con ocasión o como consecuencia del incumplimiento de cualquiera de las obligaciones anteriormente expuestas así como cualesquiera otras incluidas en las presentes Condiciones Generales y/o las impuestas por la Ley en relación con la utilización del Sitio Web .

		Proemoción velará en todo momento por el respeto del ordenamiento jurídico vigente, y estará legitimada para interrumpir, a su entera discreción, el Servicio o excluir al Cliente del Sitio Web en caso de presunta comisión, completa o incompleta, de alguno de los delitos o faltas tipificados por el Código Penal vigente, o en caso de observar cualesquiera conductas que a juicio de Proemoción resulten contrarias a estas Condiciones Generales, las Condiciones Generales de Contratación que operan para este Sitio Web, la Ley, las normas establecidas por Proemoción o sus colaboradores o puedan perturbar el buen funcionamiento, imagen, credibilidad y/o prestigio de Proemoción o sus colaboradores.

		DERECHOS DE PROPIEDAD

		Todos los contenidos del Sitio Web, tales como textos, gráficos, fotografías, logotipos, iconos, imágenes, así como el diseño gráfico, código fuente y software, son de la exclusiva propiedad de Proemoción o de terceros, cuyos derechos al respecto ostenta legítimamente Proemoción, estando por lo tanto protegidos por la legislación nacional e internacional.
		...
		Aquellos Clientes que envíen al Sitio Web observaciones, opiniones o comentarios por medio del servicio de correo electrónico o por cualquier otro medio, en los casos en los que por la naturaleza de los Servicios ello sea posible, se entiende que autorizan a Proemoción para la reproducción, distribución, comunicación pública, transformación, y el ejercicio de cualquier otro derecho de explotación, de tales observaciones, opiniones o comentarios, por todo el tiempo de protección de derecho de autor que esté previsto legalmente y sin limitación territorial. Asimismo, se entiende que esta autorización se hace a título gratuito.
		...
		Con independencia de lo establecido en las Condiciones Generales de Contratación relativas a la contratación de bienes recogidas en el presente Sitio Web, Proemoción no se hace responsable de la veracidad, exactitud y calidad del presente Sitio Web, sus servicios, información y materiales. Dichos servicios, información y materiales son presentados "tal cual" y son accesibles sin garantías de ninguna clase.

		Proemoción se reserva el derecho a interrumpir el acceso al Sitio Web, así como la prestación de cualquiera o de todos los Servicios que se prestan a través del mismo en cualquier momento y sin previo aviso, ya sea por motivos técnicos, de seguridad, de control, de mantenimiento, por fallos de suministro eléctrico o por cualquier otra causa justificada.

		En consecuencia, Proemoción no garantiza la fiabilidad, la disponibilidad ni la continuidad de su Sitio Web ni de los Servicios, por lo que la utilización de los mismos por parte del Cliente se lleva a cabo por su propia cuenta y riesgo, sin que, en ningún momento, puedan exigirse responsabilidades a Proemoción en este sentido.

		Proemoción no será responsable en caso de que existan interrupciones de los Servicios, demoras, errores, mal funcionamiento del mismo y, en general, demás inconvenientes que tengan su origen en causas que escapan del control de Proemoción, y/o debida a una actuación dolosa o culposa del Cliente y/o tenga por origen causas de caso fortuito o fuerza Mayor. Sin perjuicio de lo establecido en el artículo 1105 del Código Civil, se entenderán incluidos en el concepto de Fuerza Mayor, además, y a los efectos de las presentes Condiciones Generales, todos aquellos acontecimientos acaecidos fuera del control de Proemoción, tales como: fallo de terceros, operadores o compañías de servicios, actos de Gobierno, falta de acceso a redes de terceros, actos u omisiones de las Autoridades Públicas, aquellos otros producidos como consecuencia de fenómenos naturales, apagones, etc y el ataque de hackers o terceros especializados en la seguridad o integridad del sistema informático, siempre que Proemoción haya adoptado las medidas de seguridad razonables de acuerdo con el estado de la técnica. En cualquier caso, sea cual fuere su causa, Proemoción no asumirá responsabilidad alguna ya sea por daños directos o indirectos, daño emergente y/o por lucro cesante.

		Proemoción excluye cualquier responsabilidad por los daños y perjuicios de toda naturaleza que puedan deberse a la falta de veracidad, exactitud, exhaustividad y/o actualidad de los Servicios transmitidos, difundidos, almacenados, puestos a disposición o recibidos, obtenidos o a los que se haya accedido a través del Sitio Web así como por los Servicios prestados u ofertados por terceras personas o entidades. Proemoción tratará en la medida de lo posible de actualizar y rectificar aquella información alojada en su Sitio Web que no cumpla con las mínimas garantías de veracidad. No obstante quedará exonerada de responsabilidad por su no actualización o rectificación así como por los contenidos e informaciones vertidos en la misma. En este sentido, Proemoción no tiene obligación de controlar y no controla los contenidos transmitidos, difundidos o puestos a disposición de terceros por los Clientes o colaboradores, salvo los supuestos en que así lo exija la legislación vigente o cuando sea requerido por una Autoridad Judicial o Administrativa competente.

		De igual modo, Proemoción excluye cualquier responsabilidad por los daños y perjuicios de toda clase que puedan deberse a la presencia de virus o a la presencia de otros elementos lesivos en los contenidos que puedan producir alteración en los sistemas informáticos así como en los documentos o sistemas almacenados en los mismos.

		Proemoción no se hace responsable por la utilización que el Cliente realice de los Servicios del Sitio Web ni de sus contraseñas, así como de cualquier otro material del mismo, infringiendo los derechos de propiedad intelectual o industrial o cualquier otro derecho de terceros.

		El Cliente se obliga a mantener indemne a Proemoción, por cualquier daño, perjuicio, sanción, gasto (incluyendo, sin limitación, honorarios de abogados) o responsabilidad civil, administrativa o de cualquier otra índole, que pudiera sufrir Proemoción que guarde relación con el incumplimiento o cumplimiento parcial o defectuoso por su parte de lo establecido en las presentes Condiciones Generales o en la legislación aplicable, y, en especial, en relación con sus obligaciones relativas a protección de datos de carácter personal recogidas en las presentes condiciones o establecidas en la LOPD y normativa de desarrollo.

		ENLACES A OTROS SITIOS WEB

		Proemoción no garantiza ni asume ningún tipo de responsabilidad por los daños y perjuicios sufridos por el acceso a Servicios de terceros a través de conexiones, vínculos o links de los sitios enlazados ni sobre la exactitud o fiabilidad de los mismos. La función de los enlaces que aparecen en Proemoción es exclusivamente la de informar al Cliente sobre la existencia de otras fuentes de información en Internet, donde podrá ampliar los Servicios ofrecidos por el Portal. Proemoción no será en ningún caso responsable del resultado obtenido a través de dichos enlaces o de las consecuencias que se deriven del acceso por los Clientes a los mismos. Estos Servicios de terceros son proporcionados por éstos, por lo que Proemoción no puede controlar y no controla la licitud de los Servicios ni su calidad. En consecuencia, el Cliente debe extremar la prudencia en la valoración y utilización de la información y servicios existentes en los contenidos de terceros.
    ...
    'bootstrap.widgets.TbButton',
    array(
        'label' => 'He leído y acepto las normas y condiciones de uso',
        'type' => '',
        'htmlOptions' => array(
            'data-toggle' => 'modal',
            'data-target' => '#myModal',
