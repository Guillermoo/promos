...
<?php   $formId='categorydemo-form';
 $ajaxUrl=($model->isNewRecord)?
              ( ($_POST['create_root']!='true')?CController::createUrl('user/category/create'):CController::createUrl('user/category/createRoot')):
               CController::createUrl('user/category/update');
