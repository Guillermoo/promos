...
<?php   $formId='categorydemo-form';
 $ajaxUrl=($model->isNewRecord)?
              ( ($_POST['create_root']!='true')?CController::createUrl('user/categorydemo/create'):CController::createUrl('user/categorydemo/createRoot')):
               CController::createUrl('user/categorydemo/update');
