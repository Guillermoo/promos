...
class RegistrationController extends Controller
{
	...
	private function validaEmail($username,$soucePassword){
	...
	private function enviaEmailValidacion($model){
	...
	private function completaCampos(){
		$soucePassword = $model->password;
		$model->username = strpos($model->email,"@");
		$model->activkey=UserModule::encrypting(microtime().$model->password);
		$model->password=UserModule::encrypting($model->password);
		$model->verifyPassword=UserModule::encrypting($model->verifyPassword);
		$model->superuser=User::ID_EMPRESA;
		$model->status= User::STATUS_NOACTIVE; //Al registrarse siempre va a tener este estado, sea trial o no.
	}
